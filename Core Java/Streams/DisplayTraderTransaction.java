...
public class DisplayTraderTransaction {
	public static void main(String[] args) {
		Trader t1=new Trader("Guru", "AP");
		Trader t2=new Trader("Nikhil", "Chennai");
		Trader t3=new Trader("Roshan", "Pune");
		Trader t4=new Trader("Sandeep", "Hyderabad");
		Trader t5=new Trader("Sid", "Pune");
		Trader t6=new Trader("Farooq", "Delhi");
