...
public class DisplayNews {
	public static void main(String[] args) {
		List<News> news= Arrays.asList(
				new News(114, "TV9", "Guru", "Cases are now less, the record for this year is " ),
				new News(118, "NTV", "Karna", "Kohli  wins record 7th title or, record has officially been declared"),
				new News(122, "TV5", "Sid","School and Colleges to reopen shortly, all offices also to open"),
				new News(126, "BBC", "farooq", "India wins by 7 wickets, this is a new record, the record would help India grow in cricketworld"),
				new News(132, "DD", "Sandeep", "No team is comprising! Looks likes new record is going to be made!")
				);
